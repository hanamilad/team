      ...
      <nav aria-label="Breadcrumb" className="flex items-center justify-between">
        <ol className="flex overflow-hidden rounded-lg border border-gray-200 text-gray-600">
          <li className="flex items-center">
            <div
              className="flex h-10 items-center gap-1.5 bg-gray-100 cursor-pointer px-4 transition hover:text-gray-900"
              onClick={(e) => {
                router.back();
              }}
            >
              ...
              <span className="ms-1.5 text-xs font-medium"> الرجوع للخلف  </span>
            </div>
          </li>
